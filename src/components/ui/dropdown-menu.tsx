    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-md border p-[calc(var(--spacing-space-sm)*1)] shadow-md transition-all duration-200",
          className,
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "gap-space-md rounded-sm px-space-md py-space-sm",
        "text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50",
        "data-inset:pl-space-xl [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        "gap-space-md rounded-sm py-space-sm pr-space-md pl-space-xl text-sm outline-hidden",
        "select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none",
        "[&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 transition-all duration-200",
        className,
      )}
      checked={checked}
      {...props}
  ...
  return (
    <DropdownMenuPrimitive.RadioItem
      ...
      className={cn(
        ...
        "items-center gap-space-md rounded-sm py-space-sm pr-space-md",
        "pl-space-xl text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-space-md py-space-sm text-sm font-medium data-inset:pl-space-xl transition-all duration-200",
        className,
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-border -mx-space-xs my-space-xs h-px", className)}
      {...props}
    />
  );
}
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "rounded-sm px-space-md py-space-sm text-sm outline-hidden select-none",
        "data-inset:pl-space-xl transition-all duration-200",
        className,
      )}
      {...props}
    >
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        "origin-(--radix-dropdown-menu-content-transform-origin) overflow-hidden rounded-md border",
        "p-gap-xs shadow-lg transition-all duration-200",
        className,
      )}
      {...props}
    />
