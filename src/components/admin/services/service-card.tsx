        ...
        >
          ...
          <div className="flex items-start justify-between gap-space-sm">
            <div className="flex min-w-0 flex-col gap-space-xs">
              <span className="inline-flex self-start items-center rounded-md bg-muted px-input-x py-input-y font-mono text-xs font-semibold text-foreground ring-1 ring-border">
                {service.code}
              </span>
